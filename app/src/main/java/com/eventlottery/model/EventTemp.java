 ...
 */
public class EventTemp implements Parcelable {
    ...
    // Full constructor
    public EventTemp(String id, String name, String description, String organizerId,
    ...
    public static final Creator<EventTemp> CREATOR = new Creator<EventTemp>() {
        @Override
        public EventTemp createFromParcel(Parcel in) {
            return new EventTemp(in);
        }
        
        @Override
        public EventTemp[] newArray(int size) {
            return new EventTemp[size];
        }
    };
